    ...
    return (
        <>
            <div className='bg-[#e5e5e5]'>
                <div className="max-w-7xl mx-auto flex flex-warp gap-6 py-2 text-sm font-medium">
                    {
                        tabs.map((tab) => (
                            <button
                                key={tab}
                            ...
                            <>
                                ...
                                <div className="bg-white px-6 py-6 rounded-b-md">
                                    ...
                                    <div className="mb-3 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2 ">
                                            <span>{user?.phone || 987654321}</span>
                                            <span className="text-green-600 text-xs bg-green-100 px-2 rounded">
                                                Verified
                                            </span>
                                        </div>
                                ...
                                <div className="bg-white p-6 mt-4 rounded-md">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" value={user?.name} readOnly className="w-full mt-1 border border-gray-200 rounded-lg px-3 py-2" />
                                        </div>
                                        <div>
