                ...
                <>
                    ...
                    >
                        <div className="flex items-start gap-10">
                            ...
                            {/* Divider with fixed height as image */}
                            ...
                            <div className='flex items-start justify-between w-full'>
                                <div className="flex-1">
                                    ...
                                    <p className="text-md font-semibold text-gray-700 mt-2">
                                        <MdChair size={24} className='inline items-center mr-2' />
                                        {order.seats}
                                    </p>
                                </div>
                                <p>M-Ticket</p>
                        ...
                        <div className="p-4 text-right">
                            <p className='text-sm text-gray-500'>Ticket {order.ticket.toFixed(2)} + Convinence Fees: {order.fee.toFixed(1)}</p>
