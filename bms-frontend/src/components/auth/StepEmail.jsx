...
const StepEmail = ({ onNext }) => {
    ...
    return (
        <div className='flex flex-col gap-3 px-10 py-6'>
            <h2 className="text-center text-lg font-semibold ">Enter youe email</h2>
            <p className='text-center text-sm text-gray-500'>Tf you don't have an account, we'll create one for you.</p>
            ...
            <p className="text-[#c4c5c5] text-center m-auto text-[12px]">
                By entering your email id, you're agreeing to our{" "}<a href="" className="text-[#f74565]">Terms of Service</a> and{" "}<a href="" className="text-[#f74565]">Privacy Policy</a>. Thanks!
            </p>
        </div>
    )
}
