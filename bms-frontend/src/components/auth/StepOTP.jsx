...
const StepOTP = ({ onNext }) => {
    ...
    return (
        <div className='flex flex-col gap-3 px-10 py-6'>
            <h2 className="text-center text-lg font-semibold">Enter the code we just mailed you</h2>
            ...
            <div className='flex items-center justify-center'>
                ...
                <button
                    type='button'
                    className='w-8 cursor-pointer h-8 border border-gray-200 items-center text-[#f74565] ml-1 font-bold rounded-md'
            ...
            {isExpired ? (
                <p className='text-center text-sm text-red-500'>OTP expired. Please
                    <a href="" className='underline' onClick={handleResendOtp}>resend OTP</a> </p>
            ) : (
            ...
            <p className="text-[#c4c5c5] text-center m-auto text-[12px]">
                ...
                <a href="" className="text-[#f74565]">Terms of Service</a> and{" "}
                <a href="" className="text-[#f74565]">Privacy Policy</a>. Thanks!
            </p>
        </div>
    )
}
